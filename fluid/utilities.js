...
var Utilities = {
    ...
    normalizeVector: function (out, v) {        var magnitude = Utilities.magnitudeOfVector(v);        if (magnitude > 1e-10) {            var inverseMagnitude = 1.0 / magnitude;            out[0] = v[0] * inverseMagnitude;            out[1] = v[1] * inverseMagnitude;            out[2] = v[2] * inverseMagnitude;        } else {            out[0] = 0;            out[1] = 0;            out[2] = 0;        }        return out;    },    crossProduct: function (out, a, b) {        var ax = a[0], ay = a[1], az = a[2];        var bx = b[0], by = b[1], bz = b[2];                out[0] = ay * bz - az * by;        out[1] = az * bx - ax * bz;        out[2] = ax * by - ay * bx;        return out;    },    lerp: function (a, b, t) {        return a + t * (b - a);    },    smoothstep: function (edge0, edge1, x) {        var t = Utilities.clamp((x - edge0) / (edge1 - edge0), 0.0, 1.0);        return t * t * (3.0 - 2.0 * t);    },
